...
import 'activity/calculation_screen.dart';
import 'package:copy/l10n/app_localizations.dart';

import 'bulk_calculation_screen.dart';

class BulkCombineSelectionPage extends StatefulWidget {
  const BulkCombineSelectionPage({Key? key}) : super(key: key);

  @override
  State<BulkCombineSelectionPage > createState() =>
      _CombinedProductSelectionScreenState();
}

class _CombinedProductSelectionScreenState
    extends State<BulkCombineSelectionPage > {
  ...
  void _proceedToCalculationScreen() {
    if (_calculationResponse != null) {
      Navigator.push(
        context,
        MaterialPageRoute(
          builder: (_) => BulkCalculationScreen(
