...
class BulkOrderConfirmationScreen extends StatefulWidget {
 final OrderData orderData;

  const BulkOrderConfirmationScreen({
    super.key,
    required this.orderData,
  });

  @override
  State<BulkOrderConfirmationScreen> createState() => _OrderConfirmationScreenState();
}

class _OrderConfirmationScreenState extends State<BulkOrderConfirmationScreen> {
